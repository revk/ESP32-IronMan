...
revk_settings_t const revk_settings[]={
 {.type=REVK_SETTINGS_UNSIGNED,.gpio=1,.name="eyeleft",.comment="Left eye",.group=1,.len=7,.dot=3,.ptr=&eyeleft,.size=sizeof(revk_gpio_t),.fix=1,.set=1,.flags="- ~↓↕⇕"},
 {.type=REVK_SETTINGS_UNSIGNED,.gpio=1,.name="eyeright",.comment="Right eye",.group=1,.len=8,.dot=3,.ptr=&eyeright,.size=sizeof(revk_gpio_t),.fix=1,.set=1,.flags="- ~↓↕⇕"},
 {.type=REVK_SETTINGS_UNSIGNED,.gpio=1,.name="visorpwr",.comment="Visor servo power",.group=2,.len=8,.dot=5,.ptr=&visorpwr,.size=sizeof(revk_gpio_t),.fix=1,.set=1,.flags="- ~↓↕⇕"},
 {.type=REVK_SETTINGS_UNSIGNED,.gpio=1,.name="visorpwm",.comment="Visor service PWM",.group=2,.len=8,.dot=5,.ptr=&visorpwm,.size=sizeof(revk_gpio_t),.fix=1,.set=1,.flags="- ~↓↕⇕"},
...
#undef quote
#undef str
revk_gpio_t eyeleft={0};
revk_gpio_t eyeright={0};
revk_gpio_t visorpwr={0};
