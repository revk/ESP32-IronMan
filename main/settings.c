...
#define	STRIPS	4
 ...
 {.type=REVK_SETTINGS_UNSIGNED,.gpio=1,.name="sddat2",.comment="MicroSD DAT2",.group=2,.len=6,.dot=2,.ptr=&sddat2,.size=sizeof(revk_gpio_t),.fix=1,.set=1,.flags="- ~↓↕⇕"},
 {.type=REVK_SETTINGS_UNSIGNED,.gpio=1,.name="sddat3",.comment="MicroSD DAT3",.group=2,.len=6,.dot=2,.ptr=&sddat3,.size=sizeof(revk_gpio_t),.fix=1,.set=1,.flags="- ~↓↕⇕",.old="sdss"	},
 {.type=REVK_SETTINGS_UNSIGNED,.gpio=1,.name="sdcmd",.comment="MicroSD CMD",.group=2,.len=5,.dot=2,.ptr=&sdcmd,.size=sizeof(revk_gpio_t),.fix=1,.set=1,.flags="- ~↓↕⇕",.old="sdmosi"	},
 {.type=REVK_SETTINGS_UNSIGNED,.gpio=1,.name="sdclk",.comment="MicroSD CLK",.group=2,.len=5,.dot=2,.ptr=&sdclk,.size=sizeof(revk_gpio_t),.fix=1,.set=1,.flags="- ~↓↕⇕",.old="sdsck"	},
 {.type=REVK_SETTINGS_UNSIGNED,.gpio=1,.name="sddat0",.comment="MicroSD DAT0",.group=2,.len=6,.dot=2,.ptr=&sddat0,.size=sizeof(revk_gpio_t),.fix=1,.set=1,.flags="- ~↓↕⇕",.old="sdmiso"	},
 {.type=REVK_SETTINGS_UNSIGNED,.gpio=1,.name="sddat1",.comment="MicroSD DAT1",.group=2,.len=6,.dot=2,.ptr=&sddat1,.size=sizeof(revk_gpio_t),.fix=1,.set=1,.flags="- ~↓↕⇕"},
 {.type=REVK_SETTINGS_UNSIGNED,.gpio=1,.name="sdcd",.comment="MicroSD CD",.group=2,.len=4,.dot=2,.ptr=&sdcd,.size=sizeof(revk_gpio_t),.fix=1,.set=1,.flags="- ~↓↕⇕"},
 {.type=REVK_SETTINGS_UNSIGNED,.gpio=1,.name="micdata",.comment="Microphone Data / SD",.group=3,.len=7,.dot=3,.def="7",.ptr=&micdata,.size=sizeof(revk_gpio_t),.fix=1,.set=1,.flags="- ~↓↕⇕"},
 {.type=REVK_SETTINGS_UNSIGNED,.gpio=1,.name="micclock",.comment="Microphone Clock / SCK",.group=3,.len=8,.dot=3,.def="5",.ptr=&micclock,.size=sizeof(revk_gpio_t),.fix=1,.set=1,.flags="- ~↓↕⇕"},
 {.type=REVK_SETTINGS_UNSIGNED,.gpio=1,.name="micws",.comment="Microphone WS (not set for PDM)",.group=3,.len=5,.dot=3,.def="6",.ptr=&micws,.size=sizeof(revk_gpio_t),.fix=1,.set=1,.flags="- ~↓↕⇕"},
 {.type=REVK_SETTINGS_UNSIGNED,.gpio=1,.name="spkpwr",.comment="Speaker power on",.group=4,.len=6,.dot=3,.def="38",.ptr=&spkpwr,.size=sizeof(revk_gpio_t),.fix=1,.set=1,.flags="- ~↓↕⇕"},
 ...
 {.type=REVK_SETTINGS_UNSIGNED,.name="ledpwr",.comment="LED number for servo PWR",.group=5,.len=6,.dot=3,.ptr=&ledpwr,.size=sizeof(uint8_t),.live=1},
 {.type=REVK_SETTINGS_UNSIGNED,.name="ledpwm",.comment="LED number for servo PWM",.group=5,.len=6,.dot=3,.ptr=&ledpwm,.size=sizeof(uint8_t),.live=1},
 {.type=REVK_SETTINGS_UNSIGNED,.name="ledbutton1",.comment="LED number for button1",.group=5,.len=10,.dot=3,.ptr=&ledbutton1,.size=sizeof(uint8_t),.live=1},
 {.type=REVK_SETTINGS_UNSIGNED,.name="ledbutton2",.comment="LED number for button2",.group=5,.len=10,.dot=3,.ptr=&ledbutton2,.size=sizeof(uint8_t),.live=1},
 ...
 {.type=REVK_SETTINGS_UNSIGNED,.name="ledpulses",.comment="How many LED in pusling",.group=5,.len=9,.dot=3,.ptr=&ledpulses,.size=sizeof(uint8_t),.live=1},
 ...
 {.type=REVK_SETTINGS_UNSIGNED,.name="visorclose",.comment="Angle (degrees) visor close",.group=6,.len=10,.dot=5,.def="0",.ptr=&visorclose,.size=sizeof(uint8_t),.live=1},
 {.type=REVK_SETTINGS_UNSIGNED,.name="visoropen",.comment="Angle (degrees) visor open",.group=6,.len=9,.dot=5,.def="90",.ptr=&visoropen,.size=sizeof(uint8_t),.live=1},
